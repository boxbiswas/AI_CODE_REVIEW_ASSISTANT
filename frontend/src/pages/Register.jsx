    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
            ...
            <div className="flex items-center gap-3 mb-8 animate-fadeInUp">
                <div className="bg-white/5 rounded-xl p-2 animate-float shadow-[0_0_20px_rgba(244,114,182,0.15)] border border-sakura-pink/20">
                    <Cpu className="w-6 h-6 text-sakura-pink" />
                </div>
                <h1 className="text-2xl font-bold text-neutral-50 drop-shadow-[0_0_10px_rgba(249,168,212,0.35)]">
                    LUMUS
                </h1>
            </div>
            ...
            <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-sakura-pink/10 rounded-2xl p-8 shadow-[0_0_35px_rgba(244,114,182,0.10)] animate-fadeInUp">
                <h2 className="text-2xl font-semibold text-neutral-50 mb-6">Create Account</h2>

                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-xs font-medium uppercase tracking-wide text-neutral-400 pl-1">Name</label>
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-medium uppercase tracking-wide text-neutral-400 pl-1">Confirm Password</label>
                        <div className="relative">
                            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-500" />
                            <input
                                type="password"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full mt-2 bg-sakura-pink/90 hover:bg-sakura-pink text-black font-semibold rounded-xl py-3 shadow-[0_0_20px_rgba(244,114,182,0.2)] hover:shadow-[0_0_30px_rgba(244,114,182,0.4)] transition-all duration-300 flex justify-center items-center gap-2 disabled:opacity-70"
                    >
                ...
                <p className="mt-6 text-center text-sm text-neutral-400 border-t border-white/5 pt-6">
                    ...
                    <Link to="/login" className="text-sakura-pink hover:text-sakura-strong font-medium transition-colors">
                        Log in here
                    </Link>
                </p>
            </div>
